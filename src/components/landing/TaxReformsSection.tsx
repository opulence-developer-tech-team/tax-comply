...
const reforms = [
  ...
  {
    icon: TrendingUp,
    title: "VAT Only Over ₦25M",
    badge: "Important",
    description: "You only charge VAT if you sell more than ₦25 Million a year. Below that? No VAT required.",
    impact: "For Everyone",
    solution: "We alert you only when you cross the ₦25M sales line, so you never charge VAT by mistake.",
    urgency: "Medium",
  },
  {
    icon: Shield,
    ...
    badge: "New Benefit",
    description: "You can now deduct 20% of your annual rent from taxable income, up to a maximum of ₦500,000.",
    impact: "For Individuals",
    solution: "Enter your rent. We automatically calculate the 20% relief (capped at ₦500k) to reduce your tax.",
    urgency: "Medium",
  },
];
