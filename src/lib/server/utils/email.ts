...
export const emailService = {
  ...
  generateOTPEmailTemplate(otp: string, firstName: string, verificationLink: string): string {
    return `
      <!DOCTYPE html>
      <html lang="en">
        <head>
                  ...
                  <tr>
                    <td style="padding: 56px 48px;">
                      ...
                      <p style="margin: 0 0 40px 0; color: #4a4a4a; font-size: 15px; line-height: 1.7;">
                        Please verify your email address to complete your registration. Click the button below or use the verification code.
                      </p>
                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 0 40px 0;">
                        <tr>
                          <td align="center">
                            <a href="${verificationLink}" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #059669 0%, #047857 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 12px rgba(5, 150, 105, 0.3);">Verify Email Address</a>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 0 40px 0;">
                        <tr>
                          <td style="background-color: #f8f9fa; border: 1px solid #e8e8e8; border-radius: 6px; padding: 32px 24px;">
                            <p style="margin: 0 0 12px 0; color: #6b7280; font-size: 12px; font-weight: 500; text-transform: uppercase; letter-spacing: 0.8px; text-align: center;">Or Enter Code</p>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 560px; margin: 0 auto; background-color: #ffffff;">
                  ...
                  <tr>
                    <td style="padding: 56px 48px;">
                      ...
                      <p style="margin: 0 0 40px 0; color: #4a4a4a; font-size: 15px; line-height: 1.7;">
                        We received a request to reset your password for your TaxComply NG account. Click the button below to create a new password.
                      </p>
                      ...
                      <p style="margin: 0 0 24px 0; color: #6b7280; font-size: 13px; line-height: 1.6; text-align: center;">
                        Or copy and paste this link: <a href="${resetUrl}" style="color: #059669; text-decoration: underline;">${resetUrl}</a>
                      </p>
